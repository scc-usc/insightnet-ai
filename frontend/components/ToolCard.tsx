...
export default function ToolCard({ tool, onAsk }: ToolCardProps) {
  ...
  return (
    <div
      className="flex items-center gap-3 bg-white/70 rounded-lg px-3 py-2.5 border border-[#B1CBF5]/20 hover:bg-white/90 transition cursor-pointer"
      ...
      <div className="flex-1 min-w-0">
        ...
        {expanded && (
          <div className="mt-1 space-y-1.5">
            ...
            {tool.readme_preview && (
              <p className="text-[11px] text-[#314158]/50 leading-relaxed">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              {onAsk && (
                <button
                  ...
                  className="text-[11px] text-[#314158]/50 hover:text-[#314158]/80"
                >
                  Tell me more
                </button>
              )}
